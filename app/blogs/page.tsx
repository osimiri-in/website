    ...
    <>
      ...
      <section className="section-space">
        <div className="container-shell grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {blogs.map((blog) => (
            <Link key={blog.slug} href={`/blogs/${blog.slug}`} className="card-surface overflow-hidden">
              ...
              <div className="p-6">
                ...
                <span className="mt-5 inline-block text-sm uppercase tracking-[0.15em] text-[var(--color-gold)]">
                  Read Article
                </span>
              </div>
            </Link>
