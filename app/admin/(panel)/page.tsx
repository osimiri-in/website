      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-[#8a857c]">
            Welcome back, Himanshu. Here&apos;s what&apos;s happening across your
            product catalog.
          </p>
        </div>
        <Link
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-2">
          ...
          <div className="mt-4 space-y-3">
            {tree.length === 0 ? (
              <p className="text-sm text-[#9a948b]">
                No categories yet. Add one from the Categories page to get
                started.
              </p>
            ) : (
              tree.map((c) => (
                <div key={c.id} className="flex items-center gap-3 text-sm">
                  ...
                  <div className="h-2.5 flex-1 overflow-hidden rounded-full bg-[#f1ede6]">
                    <div
                      className="h-full rounded-full bg-[#35347a]"
        ...
        <div className="rounded-xl border border-[#e7e3db] bg-white p-5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/admin/activity" className="text-sm text-[#35347a] hover:underline">
              View all
            </Link>
          </div>
