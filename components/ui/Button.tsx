...
export function buttonClasses(
  ...
  return cn(
    ...
    variant === "primary" &&
      "bg-[var(--color-black)] text-[var(--color-warm-white)] hover:bg-[var(--color-gold)]",
    variant === "outline" &&
      "border border-[var(--color-black)] text-[var(--color-black)] hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]",
    variant === "ghost" &&
